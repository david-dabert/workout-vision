...
localforage.createInstance({ name: "workoutVision", storeName: "medical" });
localforage.createInstance({ name: "workoutVision", storeName: "food" });
...
const ProfileContext = reactExports.createContext(null);
function ProfileProvider({ children }) {
  ...
  const saveProfile$1 = reactExports.useCallback(async (updated) => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(ProfileContext.Provider, { value: { profile, saveProfile: saveProfile$1, refreshProfile, profileLoading: loading }, children });
}
function useProfile() {
...
function LanguageProvider({ children }) {
  ...
  const tExercise = reactExports.useCallback((exerciseKey, fallbackName) => {
    const key = `ex.${exerciseKey}`;
    const entry = translations[key];
    if (entry && entry[lang]) return entry[lang];
    return fallbackName || exerciseKey;
  }, [lang]);
  return /* @__PURE__ */ jsxRuntimeExports.jsx(LanguageContext.Provider, { value: { lang, setLang, t, tExercise }, children });
}
function useT() {
...
const EXERCISE_SLUG_MAP = {
  ...
  standing_leg_extension: "leg-extension",
  calf_raise: "standing-calf-raise",
  pushup: "push-up",
  overhead_press: "overhead-press",
  bench_press: "bench-press",
  dip: "dip",
  bent_over_row: "barbell-row",
  pullup: "pull-up",
  ...
  overhead_hold: "overhead-press",
  side_plank: "side-plank",
  step_up: "step-up",
  kettlebell_swing: "kettlebell-swing",
  thruster: "squat",
  clean_and_press: "deadlift",
  renegade_row: "push-up",
  turkish_getup: "plank",
  bear_crawl: "bear-crawl",
  muscle_up: "pull-up",
  chinup: "chin-up",
  box_jump: "jump-squat",
  skater_jump: "skater-hop",
  squat_jump_to_lunge: "jump-squat",
  man_maker: "push-up",
...
function getExerciseIllustration(exerciseKey, frame = 1) {
...
function resolveMuscles(muscleList) {
  ...
  for (const m of muscleList) {
    ...
    const aliases2 = MUSCLE_ALIASES[key];
    if (aliases2) {
      aliases2.forEach((a) => resolved.add(a));
    } else {
      resolved.add(m);
    }
  }
...
function BodyView({ view, primaryMuscles, secondaryMuscles, size = 120 }) {
  ...
  if (!data) return null;
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("svg", { viewBox: "20 4 60 96", width: size, height: size * 1.2, style: { display: "block" }, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("path", { d: data.outline, fill: "rgba(255,255,255,0.06)", stroke: "rgba(255,255,255,0.15)", strokeWidth: "0.8" }),
    Object.entries(data.muscles).map(([name, muscle]) => {
      ...
      return /* @__PURE__ */ jsxRuntimeExports.jsx(
        ...
        {
          d: muscle.path,
          fill: isPrimary ? "rgba(255,59,92,0.7)" : "rgba(255,59,92,0.35)",
          stroke: isPrimary ? "rgba(255,59,92,0.9)" : "rgba(255,59,92,0.5)",
          strokeWidth: "0.4",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("circle", { cx: "50", cy: "12", r: "6", fill: "rgba(255,255,255,0.08)", stroke: "rgba(255,255,255,0.15)", strokeWidth: "0.6" })
  ] });
}
function MuscleMap({ muscles, size = 100 }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "muscle-map", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "muscle-map-bodies", children: [
      (hasFrontMuscles || !hasBackMuscles) && /* @__PURE__ */ jsxRuntimeExports.jsx(BodyView, { view: "front", primaryMuscles: primary, secondaryMuscles: secondary, size }),
      hasBackMuscles && /* @__PURE__ */ jsxRuntimeExports.jsx(BodyView, { view: "back", primaryMuscles: primary, secondaryMuscles: secondary, size })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "muscle-map-legend", children: [
      [...muscles.primary || []].map((m) => /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "muscle-dot primary", children: m }, m)),
      (muscles.secondary || []).slice(0, 3).map((m) => /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "muscle-dot secondary", children: m }, m))
    ] })
  ] });
}
...
function Dashboard({ profile, modelStatus, onNavigate }) {
  const { t, lang, setLang } = useT();
  const [recentWorkouts, setRecentWorkouts] = reactExports.useState([]);
  const statusDot = modelStatus === "ready" ? "ready" : modelStatus === "error" ? "err" : "pulse";
  const statusText = modelStatus === "ready" ? t("ai_engine_ready") : modelStatus === "error" ? t("engine_failed") : t("loading_ai");
  reactExports.useEffect(() => {
  ...
  const stats = reactExports.useMemo(() => {
    ...
    const secondarySet = /* @__PURE__ */ new Set();
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "home", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "home-top", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "tagline", children: t("tagline") }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "model-status", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: `dot ${statusDot}` }),
        statusText
      ] })
    ] }),
    stats && stats.muscles.primary.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "card", style: { textAlign: "center", padding: "16px 12px" }, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(MuscleMap, { muscles: stats.muscles, size: 100 }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "stats-grid-2x2", style: { marginTop: 12, marginBottom: 0 }, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "stat-card", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "stat-card-label", children: "TOTAL REPS" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "stat-card-value", children: stats.totalReps })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "stat-card", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "stat-card-label", children: "TOTAL SETS" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "stat-card-value", children: stats.totalSets })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "stat-card", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "stat-card-label", children: "AVG FORM" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "stat-card-value", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { color: stats.avgScore >= 80 ? "var(--accent)" : stats.avgScore >= 60 ? "var(--yellow)" : "var(--red)" }, children: stats.avgScore }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { fontSize: "0.6em", color: "var(--muted)" }, children: "/100" })
          ] })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "stat-card", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "stat-card-label", children: "VOLUME" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "stat-card-value", children: [
            stats.totalVolume > 0 ? `${Math.round(stats.totalVolume)}` : "--",
            stats.totalVolume > 0 && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { fontSize: "0.5em", color: "var(--muted)", marginLeft: 2 }, children: "kg" })
          ] })
        ] })
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "nav-grid", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "div",
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "nav-icon", children: t("nav_live") }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "nav-title", children: t("nav_live_title") }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "nav-desc", children: t("nav_live_desc") })
          ]
        }
      ),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "div",
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "nav-icon", children: t("nav_video") }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "nav-title", children: t("nav_video_title") }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "nav-desc", children: t("nav_video_desc") })
          ]
        }
      ),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "div",
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "nav-icon", children: t("nav_log") }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "nav-title", children: t("nav_log_title") }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "nav-desc", children: t("nav_log_desc") })
          ]
        }
      )
    ] }),
    recentWorkouts.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { marginTop: 8 }, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { style: { marginBottom: 10 }, children: t("recent") }),
      recentWorkouts.slice(0, 5).map((w) => {
        const score = w.formScore || 0;
        return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "card", style: { padding: "12px 14px", marginBottom: 8, display: "flex", alignItems: "center", gap: 12 }, children: [
          ...
          }, children: gradeFromScore(score) }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { flex: 1, minWidth: 0 }, children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { color: "#fff", fontWeight: 700, fontSize: "0.88rem", display: "block" }, children: w.exerciseName || w.exercise }),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { textAlign: "right", flexShrink: 0 }, children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { color: "#fff", fontWeight: 800, fontSize: "1.1rem" }, children: w.reps }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { display: "block", fontSize: "0.6rem", color: "var(--muted)", textTransform: "uppercase", letterSpacing: "0.06em", fontWeight: 700 }, children: "reps" })
          ] })
        ] }, w.id);
      })
    ] })
...
function Onboarding({ onComplete }) {
  ...
  const toggleInjury = (area) => {
    ...
    const next2 = current.includes(area) ? current.filter((i) => i !== area) : [...current, area];
    update("injuries", next2);
  };
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "onboarding", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "onboarding-progress", children: Array.from({ length: TOTAL_STEPS }, (_, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
      "div",
      {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "onboarding-content", children: [
      step === 1 && /* @__PURE__ */ jsxRuntimeExports.jsx(StepWelcome, {}),
      step === 2 && /* @__PURE__ */ jsxRuntimeExports.jsx(StepBasicInfo, { data, update }),
      step === 3 && /* @__PURE__ */ jsxRuntimeExports.jsx(StepFitnessInfo, { data, update, toggleInjury }),
      step === 4 && /* @__PURE__ */ jsxRuntimeExports.jsx(StepSummary, { data })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "onboarding-actions", children: [
      step > 1 && /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { className: "btn btn-ghost", onClick: back, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(ChevronLeft, { size: 16 }),
        t("back")
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { flex: 1 } }),
      step < TOTAL_STEPS ? /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "button",
        {
      ...
      ) : /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { className: "btn btn-primary btn-lg", onClick: finish, children: [
        t("finish"),
...
function StepWelcome() {
  const { t } = useT();
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "onboarding-step text-center", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "onboarding-icon-large", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Dumbbell, { size: 48 }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("h1", { children: [
      "Workout ",
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { color: "var(--accent)" }, children: "Vision" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "onboarding-tagline", children: t("welcome_subtitle") }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "onboarding-features", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "onboarding-feature", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Activity, { size: 20, color: "var(--accent)" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: t("onb_feature_live") })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "onboarding-feature", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Target, { size: 20, color: "var(--accent)" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: t("onb_feature_progress") })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "onboarding-feature", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Dumbbell, { size: 20, color: "var(--accent)" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: t("onb_feature_nutrition") })
      ] })
    ] })
  ] });
}
function StepBasicInfo({ data, update }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "onboarding-step", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { children: t("onb_step1_title") }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted text-sm", style: { marginBottom: 16 }, children: t("onb_step1_desc") }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "form-grid", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("label", { className: "full-width", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("label", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: t("age") }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "input",
          {
            type: "number",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("label", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: t("sex") }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("select", { value: data.sex, onChange: (e) => update("sex", e.target.value), children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "male", children: t("male") }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "female", children: t("female") })
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("label", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: t("weight_kg") }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "input",
          {
            type: "number",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("label", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: t("height_cm") }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "input",
          {
            type: "number",
...
function StepFitnessInfo({ data, update, toggleInjury }) {
  const { t } = useT();
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "onboarding-step", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { children: t("onb_step2_title") }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted text-sm", style: { marginBottom: 16 }, children: t("onb_step2_desc") }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "form-grid", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("label", { className: "full-width", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: t("experience") }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("select", { value: data.experience, onChange: (e) => update("experience", e.target.value), children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "beginner", children: t("beginner") }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "intermediate", children: t("intermediate") }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "advanced", children: t("advanced") })
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("label", { className: "full-width", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: t("goal") }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("select", { value: data.goal, onChange: (e) => update("goal", e.target.value), children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "general", children: t("general_fitness") }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "strength", children: t("strength") }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "hypertrophy", children: t("muscle_growth") }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "endurance", children: t("endurance") }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "weight_loss", children: t("weight_loss") })
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("label", { className: "full-width", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: t("activity_level") }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("select", { value: data.activityLevel, onChange: (e) => update("activityLevel", e.target.value), children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "sedentary", children: t("sedentary") }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "light", children: t("light_activity") }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "moderate", children: t("moderate_activity") }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "active", children: t("active_activity") }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "veryActive", children: t("very_active_activity") })
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("label", { className: "full-width", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: t("injuries") }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { display: "flex", flexWrap: "wrap", gap: 6, marginTop: 4 }, children: INJURY_AREAS.map((area) => /* @__PURE__ */ jsxRuntimeExports.jsx(
          "button",
          {
            type: "button",
...
function StepSummary({ data }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "onboarding-step", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted text-sm", style: { marginBottom: 16 }, children: t("welcome_subtitle") }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "card", style: { marginBottom: 10 }, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { style: { margin: 0 }, children: t("profile") }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "onboarding-summary-grid", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "onboarding-summary-item", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "stat-label", children: t("goal") }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "stat-value", children: goalLabels[data.goal] || data.goal })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "onboarding-summary-item", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "stat-label", children: t("experience") }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "stat-value", style: { textTransform: "capitalize" }, children: data.experience })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "onboarding-summary-item", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "stat-label", children: t("weight_kg") }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "onboarding-summary-item", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "stat-label", children: t("height_cm") }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "stat-value", children: [
            data.height,
            " cm"
          ] })
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "onboarding-benefits", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "onboarding-benefit", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "onboarding-benefit-icon", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Target, { size: 20 }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { children: t("nav_plan_title") }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted text-sm", children: t("nav_plan_desc") })
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "onboarding-benefit", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "onboarding-benefit-icon", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Activity, { size: 20 }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { children: t("onb_feature_live") }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted text-sm", children: t("nav_live_desc") })
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "onboarding-benefit", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "onboarding-benefit-icon", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Dumbbell, { size: 20 }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { children: t("onb_feature_nutrition") }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted text-sm", children: t("nav_food_desc") })
        ] })
      ] })
    ] })
  ] });
}
const Train = reactExports.lazy(() => __vitePreload(() => import("./Train-B-SiBd_w.js"), true ? [] : void 0));
const Analyze = reactExports.lazy(() => __vitePreload(() => import("./Analyze-ZT9diX3s.js"), true ? [] : void 0));
const ManualLog = reactExports.lazy(() => __vitePreload(() => import("./ManualLog-BhKAvr5N.js"), true ? [] : void 0));
...
function AppInner() {
  ...
  const [modelStatus, setModelStatus] = reactExports.useState("loading");
  reactExports.useEffect(() => {
    let cancelled = false;
    const timeout = setTimeout(() => {
      if (!cancelled) setModelStatus("error");
    }, 15e3);
    __vitePreload(() => import("./poseAnalysis-DfzrdPrK.js"), true ? [] : void 0).then((mod) => mod.preloadModel()).then((ok) => {
  ...
  if (!profile) {
    return /* @__PURE__ */ jsxRuntimeExports.jsx(Onboarding, { onComplete: async (p) => {
      await saveProfile2(p);
      setPage("dashboard");
    } });
  }
  if (page === "train") return /* @__PURE__ */ jsxRuntimeExports.jsx(reactExports.Suspense, { fallback: LazyFallback, children: /* @__PURE__ */ jsxRuntimeExports.jsx(Train, { onClose: () => setPage("dashboard") }) });
  if (page === "analyze") return /* @__PURE__ */ jsxRuntimeExports.jsx(reactExports.Suspense, { fallback: LazyFallback, children: /* @__PURE__ */ jsxRuntimeExports.jsx(Analyze, { onClose: () => setPage("dashboard") }) });
  if (page === "log") return /* @__PURE__ */ jsxRuntimeExports.jsx(reactExports.Suspense, { fallback: LazyFallback, children: /* @__PURE__ */ jsxRuntimeExports.jsx(ManualLog, { onClose: () => setPage("dashboard") }) });
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    Dashboard,
    {
      profile,
...
function App() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx(LanguageProvider, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(ProfileProvider, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(AppInner, {}) }) });
}
...
export {
  ...
  __vitePreload as _,
  useProfile as a,
  EXERCISE_GROUPS as b,
  getExerciseIllustration as c,
  bestSide as d,
  getAllWorkouts as g,
