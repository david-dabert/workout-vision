  ...
  return (
    <div className="landing-page">
      ...
      <section style={{
        ...
        {[
          { value: '264', label: t('landing_stat_exercises') },
          { value: '33', label: t('landing_stat_landmarks') },
          { value: '100%', label: t('landing_stat_device') },
        ].map((stat, i) => (
          ...
          {[
            {
              ...
              title: t('landing_feat_form_title'),
              desc: t('landing_feat_form_desc'),
            },
            {
              ...
              title: t('landing_feat_load_title'),
              desc: t('landing_feat_load_desc'),
            },
            {
              ...
              title: t('landing_feat_privacy_title'),
              desc: t('landing_feat_privacy_desc'),
            },
            {
              ...
              title: t('landing_feat_challenge_title'),
              desc: t('landing_feat_challenge_desc'),
            },
          ].map((feature, i) => (
      ...
      {/* ── How It Works ── */}
      <section className="landing-section">
        <h2 className="landing-section-title">{t('landing_steps_title')}</h2>
