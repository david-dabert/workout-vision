...
const translations = {
  ...
  'show_details': { en: 'Form Breakdown', fr: 'Détail de la forme' },
  'hide_details': { en: 'Hide Breakdown', fr: 'Masquer le détail' },
  'show_deep_data': { en: 'Performance Data', fr: 'Données de performance' },
  'hide_deep_data': { en: 'Hide Data', fr: 'Masquer les données' },
  'analyze_another': { en: 'Analyze Another Video', fr: 'Analyser une autre vidéo' },
  'welcome_first_run': { en: 'Welcome to WorkoutVision', fr: 'Bienvenue sur WorkoutVision' },
  'welcome_first_run_text': { en: 'Record or upload a workout video and get instant AI form analysis.', fr: 'Enregistrez ou importez une vidéo et obtenez une analyse IA instantanée.' },
  'welcome_step_1': { en: 'Record or upload a video', fr: 'Enregistrez ou importez une vidéo' },
  'welcome_step_2': { en: 'AI analyzes your form', fr: "L'IA analyse votre forme" },
  'welcome_step_3': { en: 'Get rep counts and coaching tips', fr: 'Obtenez le comptage et des conseils' },
  ...
  'err_title': { en: 'Something went wrong', fr: 'Une erreur est survenue' },
  'err_message': { en: 'An unexpected error occurred. You can try again or return to the dashboard.', fr: 'Une erreur inattendue est survenue. Vous pouvez réessayer ou revenir au tableau de bord.' },
  'err_try_again': { en: 'Try again', fr: 'Réessayer' },
  'err_reload': { en: 'Reload', fr: 'Recharger' },
  'err_go_home': { en: 'Go Home', fr: 'Accueil' },
  'err_show_details': { en: 'Show technical details', fr: 'Afficher les détails techniques' },
  'link_copied': { en: 'Link copied!', fr: 'Lien copié !' },
  'shared': { en: 'Shared!', fr: 'Partagé !' },
  'challenge_response': { en: 'Challenge Response', fr: 'Réponse au défi' },
  'exercise_history_empty_hint': { en: 'Log a workout to start tracking your history.', fr: 'Enregistrez un entraînement pour commencer le suivi.' },
  ...
  'user_corrected': { en: 'User corrected', fr: 'Corrigé manuellement' },
  'eccentric_tempo': { en: 'Eccentric Tempo', fr: 'Tempo excentrique' },
  'eccentric_tempo_target': { en: 'Target: 2-4s eccentric for hypertrophy (green = in range)', fr: 'Objectif : 2-4s excentrique pour hypertrophie (vert = dans la cible)' },
  'tap_to_edit': { en: 'tap to edit', fr: 'appuyer pour modifier' },
  'recalibrating': { en: 'Recalibrating analysis...', fr: 'Recalibration en cours...' },
  'recalibrated_notice': { en: 'Analysis recalibrated to your rep count', fr: 'Analyse recalibrée selon votre nombre de reps' },
  'personal_baseline': { en: 'Personal Baseline', fr: 'Référence personnelle' },
  'sessions_count': { en: '{{count}} sessions', fr: '{{count}} séances' },
  'new_pb': { en: 'New PB!', fr: 'Nouveau record !' },
  'avg_label': { en: 'Avg', fr: 'Moy' },
  'best_label': { en: 'Best', fr: 'Meilleur' },
  'vs_avg': { en: 'vs avg', fr: 'vs moy' },
  'improving_label': { en: 'Improving', fr: 'En progrès' },
  'watch_label': { en: 'Watch', fr: 'À surveiller' },
  'progression_score': { en: 'Progression Score', fr: 'Score de progression' },
  'top_percentile': { en: 'Top {{pct}}%', fr: 'Top {{pct}}%' },
  'form_label': { en: 'Form', fr: 'Forme' },
  'consistency_label': { en: 'Consistency', fr: 'Régularité' },
  'tempo_label': { en: 'Tempo', fr: 'Tempo' },
  'power_label': { en: 'Power', fr: 'Puissance' },
  'vbt_zone': { en: 'VBT Zone', fr: 'Zone VBT' },
  'fatigue_label': { en: 'Fatigue', fr: 'Fatigue' },
  'peak_power': { en: 'Peak Power', fr: 'Puissance max' },
  'avg_power': { en: 'Avg Power', fr: 'Puissance moy.' },
  'smoothness_label': { en: 'Smoothness', fr: 'Fluidité' },
  'rep_shallower': { en: 'Rep {{rep}} was {{drop}}% shallower than rep 1', fr: 'Rep {{rep}} était {{drop}}% moins profonde que la rep 1' },
  'consistent_depth': { en: 'Consistent depth maintained across the set', fr: 'Profondeur constante maintenue sur la série' },
  'rom_per_rep': { en: 'Range of Motion', fr: 'Amplitude de mouvement' },
  'new_personal_best': { en: 'New Personal Best!', fr: 'Nouveau record personnel !' },
  'notif_prompt_title': { en: 'Get weekly workout reminders?', fr: 'Recevoir un rappel hebdomadaire ?' },
  'notif_prompt_desc': { en: 'Stay consistent — one nudge per week.', fr: 'Restez régulier — un rappel par semaine.' },
  'no_thanks': { en: 'No thanks', fr: 'Non merci' },
  'enable': { en: 'Enable', fr: 'Activer' },
  'delete_confirm_title': { en: 'Delete this workout?', fr: 'Supprimer cette séance ?' },
  'delete_confirm_desc': { en: 'This cannot be undone.', fr: 'Cette action est irréversible.' },
  ...
  'filming_tip': { en: 'For best results: film from the side, full body visible, good lighting. One person in frame.', fr: 'Pour de meilleurs résultats : filmez de côté, corps entier visible, bonne lumière. Une seule personne dans le cadre.' },
  'ios_large_file_warning': { en: 'is {size} MB. For best results on iPhone, use a video under 30 seconds.', fr: 'fait {size} MB. Pour de meilleurs résultats sur iPhone, utilisez une vidéo de moins de 30 secondes.' },
  'phase_hashing': { en: 'Indexing', fr: 'Indexation' },
  'phase_model': { en: 'AI Model', fr: 'Modèle IA' },
  'phase_extracting': { en: 'Extracting', fr: 'Extraction' },
  'phase_analyzing': { en: 'Analyzing', fr: 'Analyse' },
  'stop': { en: 'Stop', fr: 'Arrêter' },
  'limitations': { en: 'Limitations', fr: 'Limitations' },
  // ─── Workout of the Week ───
  'wotw_title': { en: 'Workout of the Week', fr: 'Exercice de la semaine' },
  'wotw_days_left': { en: '{n}d left', fr: '{n}j restants' },
  'wotw_last_day': { en: 'Last day', fr: 'Dernier jour' },
  'wotw_your_best': { en: 'Your best score', fr: 'Votre meilleur score' },
  'wotw_beat_it': { en: 'Beat it', fr: 'Battre' },
  'wotw_take_challenge': { en: 'Take the challenge', fr: 'Relever le challenge' },
  // ─── Injury Risk ───
  'training_load_monitor': { en: 'Training Load Monitor', fr: "Suivi de Charge d'Entraînement" },
  'recommendations': { en: 'Recommendations', fr: 'Recommandations' },
  'injury_disclaimer': { en: 'This feature provides general fitness guidance only and is not a medical device. Consult a healthcare provider before modifying your training based on these alerts.', fr: "Cette fonctionnalité fournit des conseils généraux de remise en forme uniquement et ne constitue pas un dispositif médical. Consultez un professionnel de santé avant de modifier votre entraînement sur la base de ces alertes." },
  ...
  'bmi': { en: 'BMI', fr: 'IMC' },
  'bmr': { en: 'BMR', fr: 'MB' },
  'voice_enabled': { en: 'Enabled', fr: 'Activé' },
  'voice_disabled': { en: 'Disabled', fr: 'Désactivé' },
  'device_capabilities': { en: 'Device Capabilities', fr: "Capacités de l'appareil" },
  'device_capabilities_desc': { en: 'Detect available hardware acceleration backends for ML inference.', fr: "Détectez les backends d'accélération matérielle disponibles pour l'inférence ML." },
  'run_benchmark': { en: 'Run Benchmark', fr: 'Lancer le benchmark' },
  'benchmark_running': { en: 'Running...', fr: 'Analyse en cours...' },
  'yes': { en: 'Yes', fr: 'Oui' },
  'no': { en: 'No', fr: 'Non' },
  'gpu_adapter': { en: 'GPU Adapter', fr: 'Adaptateur GPU' },
  'webgl2_renderer': { en: 'WebGL2 Renderer', fr: 'Moteur WebGL2' },
  'recommended_backend': { en: 'Recommended Backend', fr: 'Backend recommandé' },
  ...
  'try_demo': { en: 'Try Demo', fr: 'Voir la démo' },
  'demo_analysis_title': { en: 'Demo Analysis', fr: 'Analyse démo' },
  'demo_analysis_desc': { en: 'This is what your analysis will look like', fr: 'Voici à quoi ressemblera votre analyse' },
  'continue_setup': { en: 'Continue Setup', fr: 'Continuer la configuration' },
  'movement_assessment': { en: 'Movement Assessment', fr: 'Évaluation du mouvement' },
  'movement_assessment_desc': { en: 'Record three baseline exercises so the app can track your progress from day one.', fr: "Enregistrez trois exercices de référence pour que l'app puisse suivre votre progression dès le premier jour." },
  'onb_squat_name': { en: 'Squat', fr: 'Squat' },
  'onb_squat_desc': { en: 'Assesses lower body mobility, hip hinge depth, and knee tracking under bodyweight.', fr: 'Évalue la mobilité du bas du corps, la profondeur de la charnière de hanche et le suivi du genou au poids de corps.' },
  'onb_pushup_name': { en: 'Push-up', fr: 'Pompe' },
  'onb_pushup_desc': { en: 'Assesses upper body pressing strength, core stability, and scapular control.', fr: 'Évalue la force de poussée du haut du corps, la stabilité du gainage et le contrôle scapulaire.' },
  'onb_plank_name': { en: 'Plank', fr: 'Planche' },
  'onb_plank_desc': { en: 'Assesses core endurance, spinal alignment, and shoulder girdle stability.', fr: 'Évalue l\'endurance du gainage, l\'alignement spinal et la stabilité de la ceinture scapulaire.' },
  'start_assessment': { en: 'Start Assessment', fr: 'Démarrer l\'évaluation' },
  ...
  'ex.bench_press_side': { en: 'Bench Press (side view)', fr: 'Développé couché (vue latérale)' },
  'ex.close_grip_bench_press': { en: 'Close-Grip Bench Press', fr: 'Développé couché prise serrée' },
  ...
  'vision_score_label': { en: 'VisionScore', fr: 'VisionScore' },
  'vision_score_subtitle': { en: 'Your 30-day movement quality rating', fr: 'Votre indice qualité de mouvement sur 30 jours' },
  'vision_score_workouts': { en: '{{count}} workout · 30d', fr: '{{count}} séance · 30j' },
  'vision_score_workouts_plural': { en: '{{count}} workouts · 30d', fr: '{{count}} séances · 30j' },
  ...
  'wr_canvas_week_of': { en: 'Week of', fr: 'Semaine du' },
  'wr_canvas_form_score': { en: 'FORM SCORE', fr: 'SCORE DE FORME' },
  'wr_canvas_streak': { en: 'day streak', fr: 'jours consécutifs' },
  'wr_canvas_best_form': { en: '⭐ BEST FORM', fr: '⭐ MEILLEUR SCORE' },
  'wr_canvas_best_at': { en: 'at', fr: '—' },
  'rec_rest_needed': { en: 'Some muscle groups are still recovering. Full recovery in about {days} day(s). For today, focus on: {exercises}.', fr: 'Certains groupes musculaires récupèrent encore. Récupération complète dans environ {days} jour(s). Pour aujourd\'hui, concentrez-vous sur : {exercises}.' },
  'rec_partial': { en: 'Most muscles are recovered. Suggested session: {exercises}.', fr: 'La plupart des muscles sont récupérés. Séance suggérée : {exercises}.' },
  'rec_recovered': { en: 'Fully recovered and ready to train. Suggested session: {exercises}.', fr: 'Complètement récupéré et prêt à s\'entraîner. Séance suggérée : {exercises}.' },
...
const formCheckFr = {
  ...
  // ─── Landing Page ───
  'landing_tagline': { en: 'AI-powered form coaching that runs entirely on your device. Free. Private. No account needed.', fr: 'Coaching de forme par IA, directement sur votre appareil. Gratuit. Privé. Sans compte.' },
  'landing_start': { en: 'Start Training', fr: 'Commencer' },
  'landing_start_free': { en: 'Start Training Free', fr: 'Commencer gratuitement' },
  'landing_privacy_badge': { en: 'Zero uploads. Your videos never leave your phone.', fr: 'Zéro téléchargement. Vos vidéos restent sur votre téléphone.' },
  'landing_stat_exercises': { en: 'Exercises', fr: 'Exercices' },
  'landing_stat_landmarks': { en: 'AI Landmarks', fr: 'Points IA' },
  'landing_stat_device': { en: 'On-Device', fr: 'Sur appareil' },
  'landing_features_title': { en: 'What it does', fr: 'Fonctionnalités' },
  'landing_feat_form_title': { en: 'Real-Time Form Analysis', fr: 'Analyse de forme en temps réel' },
  'landing_feat_form_desc': { en: 'AI tracks 33 body landmarks to score your form on every rep, in real time.', fr: "L'IA suit 33 points corporels pour évaluer votre forme à chaque répétition, en temps réel." },
  'landing_feat_load_title': { en: 'Training Load Monitor', fr: 'Suivi de la charge' },
  'landing_feat_load_desc': { en: 'Detects overtraining, asymmetry growth, and form degradation before they become injuries.', fr: "Détecte le surentraînement, les asymétries et la dégradation de forme avant qu'ils ne deviennent des blessures." },
  'landing_feat_privacy_title': { en: 'Privacy-First', fr: 'Vie privée avant tout' },
  'landing_feat_privacy_desc': { en: 'No accounts. No cloud. No uploads. Everything runs in your browser using on-device AI.', fr: "Pas de compte. Pas de cloud. Pas d'envoi. Tout fonctionne dans votre navigateur avec l'IA embarquée." },
  'landing_feat_challenge_title': { en: 'Challenge Friends', fr: 'Défiez vos amis' },
  'landing_feat_challenge_desc': { en: 'Share challenges via URL. No app install needed. Compare form scores head to head.', fr: "Partagez des défis par lien. Aucune installation requise. Comparez vos scores de forme." },
  'landing_steps_title': { en: 'Three steps', fr: 'En trois étapes' },
  'landing_step1_title': { en: 'Record', fr: 'Filmer' },
  'landing_step1_desc': { en: 'Film your set with your phone camera or upload a video.', fr: 'Filmez votre série avec votre téléphone ou importez une vidéo.' },
  'landing_step2_title': { en: 'Analyze', fr: 'Analyser' },
  'landing_step2_desc': { en: 'AI detects the exercise, counts reps, and scores your form.', fr: "L'IA détecte l'exercice, compte les répétitions et évalue votre forme." },
  'landing_step3_title': { en: 'Improve', fr: 'Progresser' },
  'landing_step3_desc': { en: 'Get specific coaching cues and track progress over time.', fr: 'Recevez des conseils ciblés et suivez votre progression.' },
  'landing_science_title': { en: 'Built on Science', fr: 'Fondé sur la science' },
  'landing_science_desc': { en: 'Form checks based on Schoenfeld (2017), McGill (2010), Fry (2003). Injury prediction using Gabbett ACWR (2016). Volume thresholds from Israetel MRV guidelines.', fr: "Contrôles de forme basés sur Schoenfeld (2017), McGill (2010), Fry (2003). Prédiction des blessures selon Gabbett ACWR (2016). Seuils de volume selon les recommandations MRV d'Israetel." },
  'landing_footer': { en: 'Open source. Built with AI.', fr: 'Open source. Conçu avec l\'IA.' },

  // ─── Camera Privacy Modal ───
  'privacy_title': { en: 'Your Privacy Matters', fr: 'Votre vie privée compte' },
  'privacy_intro': { en: 'WorkoutVision analyzes your exercise form using AI pose detection. Here is what you should know:', fr: 'WorkoutVision analyse votre forme grâce à la détection de pose par IA. Voici ce que vous devez savoir :' },
  'privacy_ondevice_label': { en: '100% on-device.', fr: '100% sur appareil.' },
  'privacy_ondevice_desc': { en: 'Your video never leaves your phone. All AI processing happens locally in your browser.', fr: 'Votre vidéo ne quitte jamais votre téléphone. Tout le traitement IA est local, dans votre navigateur.' },
  'privacy_nocloud_label': { en: 'No cloud uploads.', fr: 'Aucun envoi cloud.' },
  'privacy_nocloud_desc': { en: 'No server ever sees your video, body measurements, or workout data.', fr: "Aucun serveur ne voit vos vidéos, vos mensurations ou vos données d'entraînement." },
  'privacy_noaccount_label': { en: 'No account required.', fr: 'Aucun compte requis.' },
  'privacy_noaccount_desc': { en: 'No login, no email, no tracking. Your data stays in your browser.', fr: 'Pas de connexion, pas d\'email, pas de suivi. Vos données restent dans votre navigateur.' },
  'privacy_control_label': { en: 'You are in control.', fr: 'Vous gardez le contrôle.' },
  'privacy_control_desc': { en: 'Delete all data anytime from Settings. Video frames are discarded immediately after analysis.', fr: "Supprimez toutes vos données à tout moment depuis les Paramètres. Les images vidéo sont effacées immédiatement après l'analyse." },
  'privacy_accept': { en: 'I Understand — Continue', fr: "J'ai compris — Continuer" },
  'privacy_decline': { en: 'Go Back', fr: 'Retour' },

  // ─── Subscription Gate ───
  'sub_limit_reached': { en: 'Daily limit reached', fr: 'Limite quotidienne atteinte' },
  'sub_usage': { en: '{{used}} of {{limit}} free analyses used today', fr: '{{used}} sur {{limit}} analyses gratuites utilisées aujourd\'hui' },
  'sub_feat_unlimited': { en: 'Unlimited daily analyses', fr: 'Analyses quotidiennes illimitées' },
  'sub_feat_charts': { en: 'Advanced joint angle charts', fr: 'Graphiques articulaires avancés' },
  'sub_feat_pdf': { en: 'PDF workout reports', fr: "Rapports d'entraînement PDF" },
  'sub_feat_baseline': { en: 'Form baseline tracking', fr: 'Suivi de référence de forme' },
  'sub_feat_priority': { en: 'Priority AI model access', fr: "Accès prioritaire au modèle IA" },
  'sub_monthly_cta': { en: 'Start today, cancel anytime', fr: "Commencez aujourd'hui, annulez quand vous voulez" },
  'sub_save_pct': { en: 'Save 37%', fr: 'Économisez 37%' },
  'sub_annual_value': { en: 'Best value — €2.50/month', fr: 'Meilleur tarif — 2,50€/mois' },
  'sub_privacy_note': { en: 'Everything stays on-device. No video ever leaves your phone.', fr: 'Tout reste sur votre appareil. Aucune vidéo ne quitte votre téléphone.' },
  'sub_later': { en: 'Maybe later', fr: 'Plus tard' },

  // ─── Error Boundary ───
  'error_title': { en: 'Something went wrong', fr: 'Une erreur est survenue' },
  'error_details': { en: 'Show technical details', fr: 'Afficher les détails techniques' },
  'error_reload': { en: 'Reload App', fr: "Recharger l'application" },
};
