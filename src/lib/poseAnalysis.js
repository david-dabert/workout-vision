 ...
 * - IMAGE mode for video upload analysis (single frame, no temporal state needed).
...
/**
 * Detect pose on a single image/frame (for video upload analysis).
 */
export function detectPoseImage(landmarker, imageSource) {
  try {
